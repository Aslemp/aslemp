...
@ManagedBean
@ViewScoped
public class EntradaMercanciaBean implements Serializable {
	 ...
	 */
	protected static final Logger LOGGER = Logger.getLogger(EntradaMercanciaBean.class);
	 ...
	 * Permite guardar el producto
	 */
	public void consultarProductoPorCodigoReporte() {
		try {		
			productoConsultado=productoServicio.buscarProductoPorCodigo(codigoProducto);						
